...
const caseStudiesData = {
  orion: {
    ...
    problem: 'Sistem pencarian tradisional berbasis full-text search seringkali gagal menangkap konteks semantik teknis yang kompleks, sedangkan pure vector search rentan hallucination dan lambat dalam mencocokkan kode part atau istilah eksak spesifik.',
    ...
    architectureSteps: [
      ...
      { step: '04', title: 'Grounded LLM Generation', desc: 'LLM menyusun jawaban lengkap dengan sitasi dokumen sumber dan skor keyakinan.' }
    ],
  ...
  'mbg-iot': {
    id: 'mbg-iot',
    title: 'MBG Tracker',
    tagline: 'IoT-Driven Food Waste Telemetry & Menu Optimization',
    category: 'Internet of Things & Predictive AI',
    status: 'PILOT DEPLOYMENT',
    timeline: '2024 • 3 Months',
    client: 'Institutional Catering & Sustainability Pilot',
    role: 'IoT Hardware & Backend Architect',
    overview: 'Sistem monitoring limbah makanan real-time memanfaatkan timbangan sensor IoT (ESP32) yang terhubung ke cloud broker MQTT untuk prediksi tren konsumsi menggunakan Weighted Moving Average (WMA) dan rekomendasi menu Generative AI.',
    problem: 'Tingginya tingkat makanan terbuang di fasilitas penyedia makanan institusional akibat ketiadaan data kuantitatif sisa porsi harian dan perencanaan menu yang statis.',
    solution: 'Membangun smart scale station berbasis ESP32 dengan sensor load cell yang mengirimkan data berat sisa makanan via MQTT. Data dianalisis secara prediktif dengan algoritma WMA untuk meramalkan variasi porsi, dan Gemini API diintegrasikan untuk merekomendasikan resep alternatif bergizi berbasis bahan surplus.',
    architectureSteps: [
      { step: '01', title: 'Edge Weight Sensing', desc: 'Pengukuran massa limbah makanan secara otomatis di setiap titik pengembalian nampan.' },
      { step: '02', title: 'MQTT Cloud Telemetry', desc: 'Transmisi data berlatensi rendah ke MQTT Broker dan backend FastAPI.' },
      { step: '03', title: 'WMA Trend Analysis', desc: 'Model deret waktu memprediksi volume konsumsi per jenis menu harian.' },
      { step: '04', title: 'GenAI Menu Optimizer', desc: 'Generasi rekomendasi komposisi bahan baku untuk meminimalkan sisa surplus.' }
    ],
    techStack: ['ESP32 / C++', 'MQTT / Mosquitto', 'Python / FastAPI', 'Gemini AI API', 'PostgreSQL', 'Vue 3'],
    metrics: [
...
<template>
  <div class="pt-28 pb-24 px-6 max-w-5xl mx-auto min-h-screen">
    ...
    <div class="glass-panel p-8 md:p-12 rounded-lg border border-white/15 relative tech-bracket mb-12">
    ...
    <div class="space-y-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="glass-panel p-8 rounded-lg border border-white/10 space-y-4">
          ...
          <p class="text-gray-300 text-sm font-body leading-relaxed">
